...
function resetData() {
  data = {
    channels: cache.channels.clone(),
    feeds: cache.feeds.clone(),
    categories: cache.categories.clone(),
    languages: cache.languages.clone(),
    blocklistRecords: cache.blocklistRecords.clone(),
    timezones: cache.timezones.clone(),
    regions: cache.regions.clone(),
    subdivisions: cache.subdivisions.clone(),
    cities: cache.cities.clone(),
    countries: cache.countries.clone(),
    logos: cache.logos.clone(),
